//first implementation of equation detection and crunching
...
void setup() {
  ...
  Serial.println("Input Parser & Arithmetic Unit v4");
  Serial.println("Paul Han, 2018");
  Serial.println("RPN Input Format; e.g. 2,2,+,= (2+2=) | x,x,*,4,+,= (x*x+4=)x,x");
